...
/** ******************************* CONSTANTS ****************************** **/
var COLORS = {RED:0, GREEN:1, YELLOW:2};
var AHRS_TYPE = {SPEED:0, ALT:1, HDG:2, AHRS:3, VSPEED: 4, GMETER: 5, ALL:6};
var UNITS = {KTS:0, KNOTS:0, MPH:1, MPS:2, FPS:3, FPM:4, KPH:5, MPM: 11, FEET:6, METERS:7, M:7, MILES:8, NAUTICLE_MILES:9, FPNMI:10};
var SOURCE = {AHRS:0, GPS:1, BARO:2, INPUT:3, AUTO:4};
/** ******************************* ********* ****************************** **/
...
var speedTape = {          // Speed tape on the left of the AHRS
  ...
  speeds: [                // Speed color band configurations given in MPH
    {color: COLORS.WHITE,  start: 55, end: 115},
    {color: COLORS.GREEN, start: 64, end: 140},
    {color: COLORS.YELLOW, start: 140, end: 171},
    {color: COLORS.RED, start: 171, end: 200}
  ],
